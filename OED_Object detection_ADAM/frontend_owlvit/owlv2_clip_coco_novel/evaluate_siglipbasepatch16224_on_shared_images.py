predictions_path = r'/mnt/active_storage/Joe/owlvit_results/unknown_objects_updated_with_novel_labels_obj2_cls1_siglip2-base-patch16-224.parquet'
example_output_path = r'./siglipbasepatch16224_cocoshared_example.png'
