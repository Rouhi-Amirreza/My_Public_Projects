...
print("Finished running SigLIP with novel classes over all unknown objects")

# %%
unknown_objects.to_parquet(r'/mnt/active_storage/Joe/owlvit_results/unknown_objects_updated_with_novel_labels_obj2_cls1_siglip2-base-patch16-224.parquet')